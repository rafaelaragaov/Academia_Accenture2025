...
const BTN_EDITNOVO = '#edit-record-4'
const BTN_EDITEXISTENTE = '#edit-record-3'

Cypress.Commands.add('editaCadastroNovo', () => {
    cy.get(BTN_EDITNOVO).click()
})

Cypress.Commands.add('editaCadastroExistente', () => {
    cy.get(BTN_EDITEXISTENTE).click()
})
